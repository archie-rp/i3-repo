...
{
  case $1 in
  	$1)  sudo tee /sys/class/backlight/intel_backlight/brightness 
  	<<< $1 ;;
  	esac 
}
radio-station()
{
 ...
 2) mplayer -playlist ~/.radio/listen.pls ;;
 3) mplayer -playlist ~/.radio/mega_hitsaac.pls ;;
 4) mplayer -playlist ~/.radio/rfmaac.pls ;; 
 5) mplayer -playlist ~/.radio/energy106.pls ;;
 6) mplayer -prefer-ipv4 -playlist ~/.radio/real_dance_radio.pls ;;
 7) mplayer -prefer-ipv4 -playlist ~/.radio/dance_radio.m3u ;;
 8) mplayer -prefer-ipv4 -playlist ~/.radio/radio_now.m3u;;
 9) mplayer -prefer-ipv4 -playlist ~/.radio/folly_radio.m3u ;;
 esac
}
